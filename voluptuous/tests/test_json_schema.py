...
from voluptuous import (
    Schema, Required, Optional, All, Any, Range, Length, In, Match, Email, Url,
    Date, Datetime, Coerce, Clamp, ExactSequence, to_json_schema
)
...
class TestComplexSchemas:
    ...
    def test_user_profile_schema(self):
        ...
        voluptuous_schema = Schema({
            Required('username'): All(str, Length(min=3, max=20), Match(r'^[a-zA-Z0-9_]+$')),
